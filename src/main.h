...
static const int VERSION1_5_SWITCH_BLOCK = 999999999; //  (never now) wasBlock 1.6 million, approx same time
...
static const int POW_LIMIT_HEIGHT =  405710 ; // Limit Flash PoW Mining.
static const int POW_STOP_HEIGHT =  600000000; // (never)Limit PoW Mining.
static const int64_t POW_TIME_LIMIT = 60 * 1; // Time for PoW to wait to find block

static const unsigned int VERSION_2_0_SWITCH_TIME = 1546908699; // Fri, 15 Sep 2017 21:00:00
static const int SPACING_TARGET_SWITCH =  407175; // Change The Spacing Time
...
//static const uint256 hashGenesisBlockOfficial("0x000006c7ca9e3c4739d13d4abab72f4c7afd47bf58060d37f4c08a4157942e0a");
static const uint256 hashGenesisBlockOfficial("0xe857102c34525d8d5822d849bc90746192dd4d15d090b8b794d9a33c55d06c51");
static const uint256 hashGenesisBlockTestNet("0xa0111ca1c43ff3109a4317c09ba96a403ba5895ee3924954b86637c52b3f178c");
...
public:
    ...
    unsigned int GetStakeEntropyBit(unsigned int nHeight) const
    {
        ...
        // Protocol switch to support p2pool at NanoCheeZe block #9689
        ...
        // Before NanoCheeZe block #9689 - old protocol
...
public:
    ...
    std::string ToString() const
    {
        return strprintf("CBlockIndex(nprev=%p, pnext=%p, nFile=%u, nBlockPos=%-6d nHeight=%d, nMint=%s, nMoneySupply=%s, nFlags=(%s)(%d)(%s), nStakeModifier=%016, hashProofOfStake=%s, prevoutStake=(%s), nStakeTime=%d merkle=%s, hashBlock=%s)",
            pprev, pnext, nFile, nBlockPos, nHeight,
            FormatMoney(nMint), FormatMoney(nMoneySupply),
            GeneratedStakeModifier() ? "MOD" : "-", GetStakeEntropyBit(), IsProofOfStake()? "PoS" : "PoW",
            nStakeModifier, hashProofOfStake.ToString(),
