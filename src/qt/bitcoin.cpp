...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. NanoCheeZe can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "NanoCheeZe",
    ...
    app.setOrganizationName("NanoCheeZe");
    app.setOrganizationDomain("NanoCheeZe.info");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("NanoCheeZe-Qt-testnet");
    else
        app.setApplicationName("NanoCheeZe-Qt");
...
#if defined(Q_OS_WIN) && QT_VERSION >= 0x050000
                 WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("NanoCheeZe shutting down. Please wait..."), (HWND)window.getMainWinId());
#endif
