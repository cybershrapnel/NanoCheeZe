...
{
    resize(850, 550);
    setWindowTitle(tr("NanoCheeZe") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&NanoCheeZe"), this);
    overviewAction->setStatusTip(tr("Show view of wallet(s)"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NanoCheeZe address"));
    ...
    charityAction = new QAction(QIcon(":/icons/stake"), tr("&Staking"), this);
    charityAction->setStatusTip(tr("Enable Stake Splitting"));
    ...
    //blockAction = new QAction(QIcon(":/icons/blexp"), tr("&Block Browser"), this);
	    blockAction = new QAction(QIcon(":/icons/blocks"), tr("&Blocks"), this);
    ...
    blocksIconAction = new QAction(QIcon(":/icons/info"), tr("&Current Block"), this);
    blocksIconAction->setStatusTip(tr("Get Current Block Information"));
    blocksIconAction->setToolTip(blocksIconAction->statusTip());
	//blocksIconAction->setCheckable(true);
	//tabGroup->addAction(blocksIconAction);
	
    stakingIconAction = new QAction(QIcon(":/icons/info"), tr("&Network Info"), this);
	...
	//stakingIconAction->setCheckable(true);
	//tabGroup->addAction(stakingIconAction);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About NanoCheeZe"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NanoCheeZe"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NanoCheeZe addresses to prove you own them"));

    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NanoCheeZe addresses"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->addAction(blocksIconAction);
	toolbar->addAction(stakingIconAction);
...
#ifndef Q_OS_MAC
    trayIcon->setToolTip(tr("NanoCheeZe client"));
...
void BitcoinGUI::blocksIconClicked()
{
    ...
    message(tr("Block Chain Information"),
        tr("Client Version: %1\n"
           ...
           .arg(tr("5.0000000")) // Hard Coded as NCZ is always 5, but should use GetProofOfWorkReward
...
void BitcoinGUI::stakingIconClicked()
{
    ...
    message(tr("Network Information"),
      tr("Client Version: %1\n"
         "Protocol Version: %2\n\n"
         ...
         "Stake Splitting Address: %14\n"
         "Stake Splitting Percentage: %15\n\n"
         ...
         .arg(strAddress.IsValid() ? strAddress.ToString().c_str() : "Not Splitting")
         .arg(nPer)
         .arg(walletManager->GetWalletCount())
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NanoCheeZe network", "", count));
}
...
{
    QString strTitle = tr("NanoCheeZe") + " - ";
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction requires a fee of %1. "
          "Fees are returned to the bank's mineable pool to ensure infinite mining. "
    ...
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            walletStack->gotoSendCoinsPage();
             ...
             message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid NanoCheeZe address or malformed URI parameters."),
